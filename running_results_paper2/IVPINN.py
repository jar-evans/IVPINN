...
class IVPINN():
    ...
    def construct_RHS(self):
        ...
        #Factors = np.ones((self.n_vertices,1),dtype=np_type)
        importance=0.5
        ...
        #self.Factors=tf.constant(Factors,dtype=tf_type)
